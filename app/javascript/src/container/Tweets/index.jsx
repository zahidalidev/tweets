    ...
    <div className='flex justify-center w-screen'>
      <div className='flex flex-row justify-center w-9/12	mt-10'>
        ...
        <div className='flex flex-col w-2/4 feed'>
          ...
          <div className='bg-white mt-2.5 rounded-sm p-7 border-b border-t border-solid	border-inherit'>
            <div className='flex items-start text-sm'>
              ...
              <div>
                ...
                <span className='font-normal text[#657786] ml-1' >. Jun 27</span>
                <p className='mt-1.5' >
                  🔥 If you're tired of using outline styles for secondary buttons, a soft solid
                  background based on the text color can be a great alternative.
                </p>
              </div>
            </div>
            ...
            <div className='tweet-info-counts flex ml-[60px] mr-[10px] mt-[10px]'>
              ...
              <div className='flex mr-[20px]'>
                ...
                <div className='flex mr-[23px]'>397</div>
              </div>
              ...
              <div className='flex mr-[20px]'>
                ...
                <div className='flex mr-[20px]'>2.6k</div>
              </div>
